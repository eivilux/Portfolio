<div class="flex flex-col gap-12 lg:grid lg:grid-cols-12 lg:gap-16">
	...
	<div class="flex items-end lg:col-span-4">
		<div
			class="flex w-full flex-col gap-6 border-l border-primary pl-6 lg:flex-row lg:items-center lg:gap-8"
		>
			<p class=" text-2xl font-light text-text italic sm:text-3xl">
				« Vous êtes votre plus bel outil pour exploiter le champ des possibles. »
			</p>
		</div>
	</div>
</div>
